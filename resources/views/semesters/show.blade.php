    ...
    <x-slot name="header">
        <div class="flex justify-between items-center py-2">
            <div class="flex items-center gap-2">
                <a href="{{ route('periods.show', $semester->id) }}"
                ...
                <h1 class="text-base md:text-2xl font-bold">{{ $semester->name }}</h1>
            </div>
                ...
                <tbody>
                    @foreach ($sessions as $session)
                        <tr
                            ...
                            <td class="px-6 py-4 font-semibold">{{ $session->semester->name }}</td>
