            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('faculties.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="short_name" id="short_name" value="{{ old('short_name') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('short_name') border-red-500 @enderror" required>
