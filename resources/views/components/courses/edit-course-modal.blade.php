            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('courses.update', $course) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name-{{ $course->id }}" value="{{ old('name', $course->name) }}" autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('name') border-red-500 @enderror" required>
