@php
    ...
    $color = [
        ...
        'info' => 'text-sky-800 bg-sky-100 border border-sky-300',
    ][$type] ?? 'text-sky-800 bg-sky-100 border border-sky-300';
    $icon = [
        ...
        'info' => '<svg class="w-5 h-5 text-sky-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M12 20a8 8 0 100-16 8 8 0 000 16z" /></svg>',
    ][$type] ?? '<svg class="w-5 h-5 text-sky-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M12 20a8 8 0 100-16 8 8 0 000 16z" /></svg>';
    $classes = "$base $color";
@endphp
